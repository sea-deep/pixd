  ...
  */
  ...
  if (message.mentions.users.size !== 1) {
    if (interaction.component.label === 'Rematch (1/2)') {
      ...
      content[0] = randBool ? `${redDisk}<@${message.mentions.parsedUsers.first().id}> VS ${yellowDisk}<@${message.mentions.parsedUsers.at(1).id}>` : content[0];
  ...
  return [
    {
      type: 1,
      components: [
        { style: 2, custom_id: 'oneC4', disabled: false, emoji: { id: null, name: '1️⃣' }, type: 2 },
        { style: 2, custom_id: 'twoC4', disabled: false, emoji: { id: null, name: '2️⃣' }, type: 2 },
        { style: 2, custom_id: 'threeC4', disabled: false, emoji: { id: null, name: '3️⃣' }, type: 2 },
        { style: 2, custom_id: 'fourC4', disabled: false, emoji: { id: null, name: '4️⃣' }, type: 2 },
      ],
    },
    {
      type: 1,
      components: [
        { style: 2, custom_id: 'fiveC4', disabled: false, emoji: { id: null, name: '5️⃣' }, type: 2 },
        { style: 2, custom_id: 'sixC4', disabled: false, emoji: { id: null, name: '6️⃣' }, type: 2 },
        { style: 2, custom_id: 'sevenC4', disabled: false, emoji: { id: null, name: '7️⃣' }, type: 2 },
      ],
    },
  ];
}
