...
export default new HybridCommand({
   ...
   */
  options: [
    { type: 3, name: "action", description: "Action or pin name (add, remove, list, or existing pin name)", required: false },
    { type: 3, name: "name", description: "Pin name (when adding or removing)", required: false },
    { type: 3, name: "content", description: "Pin content (when adding a pin)", required: false },
    { type: 11, name: "image", description: "Optional image attachment for the pin", required: false },
  ],
