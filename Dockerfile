...
WORKDIR /usr/src/app
RUN apt-get update && apt-get install -y --no-install-recommends ca-certificates ffmpeg python3 python3-pip python3-venv python-is-python3 libgomp1 && rm -rf /var/lib/apt/lists/*
COPY package.json package-lock.json ./
